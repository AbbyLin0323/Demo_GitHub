...
SET DRIVER_BASE=.\Driver_Plx8000\chk
...
SC QUERYEX Plx8000 > NUL
IF NOT ERRORLEVEL 1060 goto _Error_SvcInstalledAlready

REM Verify driver doesn't already exist
IF EXIST %systemRoot%\System32\Drivers\Plx8000.sys goto _Error_DriverExists
...
IF NOT EXIST %_PLX_SVC_DIR%\Plx8000.sys goto _Error_DriverNotFound

echo - Copy %_PLX_SVC_DIR%\Plx8000.sys --^> %systemRoot%\System32\Drivers...
Copy %_PLX_SVC_DIR%\Plx8000.sys %systemRoot%\System32\Drivers > NUL

echo - Request SCM to create the service...
SC CREATE Plx8000 binPath= System32\Drivers\Plx8000.sys type= kernel ^
...
SC DELETE Plx8000 > NUL
IF ERRORLEVEL 1060 goto _Error_SvcNotInstalled
IF ERRORLEVEL 1 goto _Error_SCM

echo - Delete %systemRoot%\System32\Drivers\Plx8000.sys...
IF EXIST %systemRoot%\System32\Drivers\Plx8000.sys Del %systemRoot%\System32\Drivers\Plx8000.sys > NUL
...
REG SAVE "HKLM\System\CurrentControlSet\services\Plx8000" .\_Pres_PlxReg.hiv /y > NUL
IF ERRORLEVEL 1 goto _Error_REG
...
echo - Backup ^& Delete %systemRoot%\System32\Drivers\Plx8000.sys...
Copy %systemRoot%\System32\Drivers\Plx8000.sys .\_Pres_Plx8000.sys > NUL
Del %systemRoot%\System32\Drivers\Plx8000.sys > NUL
...
IF NOT EXIST .\_Pres_Plx8000.sys goto _Error_PreservedDriverNotFound

REM Get previous driver stopped state
IF EXIST .\_Pres_PlxState.bat SET _PLX_PRES_STATE_STOPPED=1

echo - Copy backup of Plx8000.sys --^> %systemRoot%\System32\Drivers...
Copy .\_Pres_Plx8000.sys %systemRoot%\System32\Drivers\Plx8000.sys > NUL
...
REG RESTORE "HKLM\System\CurrentControlSet\services\Plx8000" .\_Pres_PlxReg.hiv > NUL
IF ERRORLEVEL 1 goto _Error_REG
:_Skip_RegRestore
...
:_Error_DriverExists
echo ERROR: Plx8000.sys already exists in %systemRoot%\System32\Drivers
echo        Please delete this file and re-run the scipt.
goto _Exit


:_Error_DriverNotFound
echo ERROR: Plx8000.sys not found in %_PLX_SVC_DIR%
goto _Exit


:_Error_PreservedDriverNotFound
echo ERROR: _Pres_Plx8000.sys not found in current dir (%CD%)
goto _Exit
