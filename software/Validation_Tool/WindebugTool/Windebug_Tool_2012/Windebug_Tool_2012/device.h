...
* Author       :   JackeyChai
* 
* Description: sata device information 
* 
* Depend file:
* 
* Export file:
...
#define SDRAM_TYPE_DDR2 0
#define SDRAM_TYPE_DDR3 1

#define REG_WRITE 0
#define REG_READCHK 1
#define REG_MODIFY 2
#define REG_OPEND 3

#define MEMREGION_OTFB 0
#define MEMREGION_DRAM 1
...
extern U8 disk_detect();
extern void disk_array_show();
extern void disk_init_testdisk(U8 disk_index);
extern void disk_special_cmd(U32 cmdcode);
/*
extern	U32 disk_read_sync(U32 start_lba,U16 len,U8*data_buffer);
extern  U32 disk_write_sync(U32 start_lba,U16 len,U8*data_buffer);
extern	U32 disk_write_async(U32 start_lba,U16 len,U32*data_buffer);
extern	U32 disk_read_async(U32 start_lba,U16 len,U32*data_buffer);
extern	U32 disk_wait_async_finish();
*/

extern U8 disk_detect_sim();
extern void disk_get_sync_handle(HANDLE *g_disk_handle);
extern void disk_get_async_handle(HANDLE *g_disk_handle);
extern void disk_scan_changes();
extern BOOL ProgramRegByTable(PREGENTRY RegTable);
extern BOOL InitializeTargetSDRAM(U8 ucSDRAMType);
extern BOOL SetTargetMemStorageArea(U8 ucMemAreaID);
