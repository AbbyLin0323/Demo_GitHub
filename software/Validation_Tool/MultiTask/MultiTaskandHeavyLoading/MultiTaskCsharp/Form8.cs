...
namespace MultiTaskCsharp
{
    public partial class Form8 : Form
    {
        ...
        public Form8(Form1 form1)
        {
            InitializeComponent();
            this.form1 = form1;
            output_T7 = TextWriter.Synchronized(new TextBoxWriter(T7_Information));
            this.Closing += new System.ComponentModel.CancelEventHandler(Form8_Closing);
        ...
        {
            form1.Task[6].Abort();
            CloseHandle(form1.File_dest[6]);
            CloseHandle(form1.File_src[6]);
            //form1.Delete_File((Byte)7, (Byte)1);
