...
#define DWORD_SIZE_MSK              (DWORD_SIZE - 1)

/* QWORD size in Byte is 8 */
#define QWORD_SIZE_BITS             3
#define QWORD_SIZE                  (1 << QWORD_SIZE_BITS)
#define QWORD_SIZE_MSK              (QWORD_SIZE - 1)

/* Kilo Byte size in Byte is 10 */
#define KB_SIZE_BITS                10
#define KB_SIZE                     (1 << KB_SIZE_BITS)
#define KBYTE_SIZE_MSK              (KB_SIZE - 1)
...
#define   THIRTYTWOKB_SIZE_BITS     (LOGIC_PIPE_PG_SZ_BITS)  
