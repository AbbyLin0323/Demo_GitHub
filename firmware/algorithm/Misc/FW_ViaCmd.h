...
/*============================================================================*/
void FW_ViaCmdInit(U32 *pFreeDramBase);
BOOL FW_ViaCmdDevCtrl(SCMD* pSCMD);
void FW_ViaCmdPrepareData(SCMD* pSCMD);
void FW_ViaCmdXferDataDone(SCMD* pSCMD);
