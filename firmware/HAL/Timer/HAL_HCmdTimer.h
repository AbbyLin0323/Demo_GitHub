...
#define rTimerSelect    (*(volatile U32 *)(REG_BASE_EXT_NVME_CRL + 0x20))
#define rTimerValue     (*(volatile U32 *)(REG_BASE_EXT_NVME_CRL + 0x24))
#define rTimerStop1     (*(volatile U32 *)(REG_BASE_EXT_NVME_CRL + 0x28))
#define rTimerStop2     (*(volatile U32 *)(REG_BASE_EXT_NVME_CRL + 0x2C))
