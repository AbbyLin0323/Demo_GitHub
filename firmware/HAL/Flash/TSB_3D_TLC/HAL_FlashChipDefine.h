...
#ifdef TSB_3D_TLC_BICS3
#define BLK_PER_PLN                 (1366)   //1478(Total Block) - 112(Rsv Block)
#define RSV_BLK_PER_PLN             (112)
#else
#define BLK_PER_PLN                 (1821)   //1972(Total Block) - 151(Rsv Block)
#define RSV_BLK_PER_PLN             (151)
#endif

// Page/Wl Address
#define PG_PER_BLK_BITS             (8)   // Page bit in flash row address

#ifdef TSB_3D_TLC_BICS3
#define PG_PER_BLK                  (256)
#else
#define PG_PER_BLK                  (192)
#endif
...
#define EMPTY_THRD_LAST_1K         (9830)   // 1024B + 2B(CRC) + 4B(LBA) + 64B(RED) + 136B(ECC), N0 is 10 => ((1024+2+4+64+136)*8) - 10 = 9830
...
#define PAIR_PAGE_INTERVAL_MAX      (1)
