...
20151221    abby      add TSB 3D TLC support
*******************************************************************************/
...
------------------------------------------------------------------------------*/
/* MLC/SLC retry */
#define HAL_FLASH_READRETRY_CNT         16   // flash retry times max in FW usage
#define HAL_FLASH_MAX_RETRY_TIME        16   // Vth adjust time max
#define HAL_FLASH_RETRY_PARA_MAX        1   // parameter number max in once Vth adjust
/* TLC retry */
#define HAL_TLC_FLASH_READRETRY_CNT     31
#define HAL_TLC_FLASH_MAX_RETRY_TIME    31  // TLC max 31
#define HAL_TLC_FLASH_RETRY_PARA_MAX    2   // 2 DW total 7 parameters
...
{
    CQE1E_EF,CQE1E_FA,CQE1E_FF,CQE1E_03,
    CQE1E_90,CQE1E_00,CQE1E_30,CQE1E_60,
    CQE1E_EE,CQE1E_31,CQE1E_3F,CQE1E_FC,
...
typedef enum _CQE2E_INDEX
{
    ...
    CQE2E_1180,CQE2E_1A85,CQE2E_E005,CQE2E_1085,
    CQE2E_3060,CQE2E_1580,CQE2E_3200,CQE2E_3100,
    CQE2E_3C60,CQE2E_1581,CQE2E_1A80,CQE2E_1185   
}CQE2E_INDEX;
...
#ifndef BOOTLOADER
    /*  SLC FULL PLN cmd, 15nm TSB TLC is 2 PLN flash  */  /* SLC CMD Pending  */
...
typedef struct _RETRY_PARA_
{
    ...
    U32 bsAddr:8;  
    U32 bsRsv:16;
    U32 bsData:32;  //1 DW feature value for TSB 3D TLC 
}RETRY_PARA;
...
typedef enum _RETRY_PARA_GROUP_INDEX_
{
    ...
    TLC_RETRY_PARA_GROUP6,
    TLC_RETRY_PARA_GROUP7,
    TLC_RETRY_PARA_GROUP8,
    TLC_RETRY_PARA_GROUP9,
    TLC_RETRY_PARA_GROUP10,
    TLC_RETRY_PARA_GROUP11,
    TLC_RETRY_PARA_GROUP12,
    TLC_RETRY_PARA_GROUP13,
    TLC_RETRY_PARA_GROUP14,
    TLC_RETRY_PARA_GROUP15,
#if 0//pending    
    TLC_RETRY_PARA_GROUP16,
    TLC_RETRY_PARA_GROUP17,
    TLC_RETRY_PARA_GROUP18,
    TLC_RETRY_PARA_GROUP19,
    TLC_RETRY_PARA_GROUP20,
    TLC_RETRY_PARA_GROUP21,
    TLC_RETRY_PARA_GROUP22,
    TLC_RETRY_PARA_GROUP23,
    TLC_RETRY_PARA_GROUP24,
    TLC_RETRY_PARA_GROUP25,
    TLC_RETRY_PARA_GROUP26,
    TLC_RETRY_PARA_GROUP27,
    TLC_RETRY_PARA_GROUP28,
    TLC_RETRY_PARA_GROUP29,
    TLC_RETRY_PARA_GROUP30,
#endif
    TLC_RETRY_CNT,
...
#ifdef NF_PRCQ_SLC_ERS
#undef NF_PRCQ_SLC_ERS
#endif
#define NF_PRCQ_SLC_ERS NF_PRCQ_ERS
...
#ifdef NF_PRCQ_SLC_PRG
#undef NF_PRCQ_SLC_PRG
#endif
#define NF_PRCQ_SLC_PRG NF_PRCQ_PRG
...
#ifdef NF_PRCQ_SLC_READ
#undef NF_PRCQ_SLC_READ
#endif
#define NF_PRCQ_SLC_READ NF_PRCQ_READ
