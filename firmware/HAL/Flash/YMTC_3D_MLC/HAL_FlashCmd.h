...
------------------------------------------------------------------------------*/
/* MLC/SLC retry */
#define HAL_FLASH_READRETRY_CNT         5
#define HAL_FLASH_MAX_RETRY_TIME        5
...
typedef enum _CQE1E_INDEX  
{
    ...
    CQE1E_FC,CQE1E_FD,CQE1E_DA,CQE1E_DF
}CQE1E_INDEX;
...
typedef enum _PRCQ_TYPE 
{
    ...
    /*  MLC 1PLN cmd  */
    FLASH_PRCQ_MLC_ERS_1PLN,    //10
    FLASH_PRCQ_MLC_READ_1PLN,
    FLASH_PRCQ_MLC_PRG_1PLN,
    FLASH_PRCQ_MLC_PRG_SING_PG_1PLN,    //single page mode
...
#ifdef NF_PRCQ_HARD_RESET
#undef NF_PRCQ_HARD_RESET
#endif
#define NF_PRCQ_HARD_RESET FLASH_PRCQ_HARD_RESET
...
#ifdef NF_PRCQ_MLC_ERS
#undef NF_PRCQ_MLC_ERS
#endif
#define NF_PRCQ_MLC_ERS FLASH_PRCQ_MLC_ERS_1PLN

#ifdef NF_PRCQ_MLC_PRG
#undef NF_PRCQ_MLC_PRG
#endif
#define NF_PRCQ_MLC_PRG FLASH_PRCQ_MLC_PRG_1PLN

#ifdef NF_PRCQ_MLC_READ
#undef NF_PRCQ_MLC_READ
#endif
#define NF_PRCQ_MLC_READ FLASH_PRCQ_MLC_READ_1PLN
