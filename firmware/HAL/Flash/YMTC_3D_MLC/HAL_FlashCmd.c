...
GLOBAL MCU12_VAR_ATTR PRCQ_TABLE g_aPrcqTable[FLASH_PRCQ_CNT] =
{
    ...
    {FLASH_PRCQ_HARD_RESET,                    NF_NORMAL_CMD,  TRIG_CMD_OTHER,   INVALID_BIT(9),    0},
    ...
    /*  MLC 1PLN cmd  */
    {FLASH_PRCQ_MLC_ERS_1PLN,                  NF_NORMAL_CMD,  TRIG_CMD_ERASE,   INVALID_BIT(9),    0},
    {FLASH_PRCQ_MLC_READ_1PLN,                 NF_NORMAL_CMD,  TRIG_CMD_READ,    INVALID_BIT(9),    0},
    {FLASH_PRCQ_MLC_PRG_1PLN,                  NF_NORMAL_CMD,  TRIG_CMD_WRITE,   INVALID_BIT(9),    0},
    {FLASH_PRCQ_MLC_PRG_SING_PG_1PLN,          NF_NORMAL_CMD,  TRIG_CMD_WRITE,   INVALID_BIT(9),    0},
...
GLOBAL MCU12_DRAM_TEXT U8 l_aQETable[] =
{
    ...
    // FLASH_PRCQ_HARD_RESET
    QE_GRP_ATTR(PRCQ_ONE_CYCLE_CMD)     |QE_INDEX(CQE1E_FD),
    QE_GRP_ATTR(PRCQ_READ_STATUS)       |QE_INDEX(SQEE_3E70),
    QE_GRP_ATTR(PRCQ_FINISH)            |QE_INDEX(END),
    ...
    /* ===== MLC mode single plane ===== */
    //FLASH_PRCQ_MLC_ERS_1PLN
#ifndef SLC_SHIFT_ADDR_TEST
    ...
    //FLASH_PRCQ_MLC_PRG_1PLN
#ifndef SLC_SHIFT_ADDR_TEST
    QE_GRP_ATTR(PRCQ_ONE_CYCLE_CMD)     |QE_INDEX(CQE1E_DF),
#endif
    QE_GRP_ATTR(PRCQ_THREE_PHASE_CMD)   |QE_INDEX(CQE2E_1080),
    QE_GRP_ATTR(PRCQ_FIVE_CYCLE_ADDR)   |QE_INDEX(ADDR0),       //low page
    QE_GRP_ATTR(PRCQ_DMA_WRITE)         |QE_INDEX(ADDR0),
#ifdef OTP_TEST
...
#endif    
    QE_GRP_ATTR(PRCQ_THREE_PHASE_CMD)   |QE_INDEX(CQE2E_1080),
    QE_GRP_ATTR(PRCQ_FIVE_CYCLE_ADDR)   |QE_INDEX(ADDR1),       //upp page
    ...
    //FLASH_PRCQ_MLC_PRG_SING_PG_1PLN
#ifndef SLC_SHIFT_ADDR_TEST
    QE_GRP_ATTR(PRCQ_ONE_CYCLE_CMD)     |QE_INDEX(CQE1E_DF),
#endif
    QE_GRP_ATTR(PRCQ_THREE_PHASE_CMD)   |QE_INDEX(CQE2E_1080),
...
void MCU12_DRAM_TEXT HAL_NfcPrcqTableInit(void)
{
    ...
    for (ucCmdCodeIndex = 0; ucCmdCodeIndex < FLASH_PRCQ_NON_PIO_NUM; ucCmdCodeIndex++)
    {
        ...
        ulPrcqDwCnt = ulByteCnt >> DWORD_SIZE_BITS;
    }
