...
{
    0x3000,0x1080,0x3c60,0xD060,
    0x1180,0x1081,0xe005,0x3160,
    0x3060,0x1185,0x3200,0x3100,
    0x1A85,0x1085,0x1A80,0x1580
};
#if 0//extend for future
...
GLOBAL MCU12_VAR_ATTR PRCQ_TABLE g_aPrcqTable[FLASH_PRCQ_CNT] =
{
    ...
    {FLASH_PRCQ_TLC_2ND_PRG_1PLN,        NF_NORMAL_CMD,  TRIG_CMD_WRITE,   INVALID_BIT(9),    0},
    {FLASH_PRCQ_TLC_3RD_PRG_1PLN,        NF_NORMAL_CMD,  TRIG_CMD_WRITE,   INVALID_BIT(9),    0},
    ...
    {FLASH_PRCQ_TLC_2ND_PRG_FULL_PLN,          NF_NORMAL_CMD,  TRIG_CMD_WRITE,   INVALID_BIT(9),    0},
    {FLASH_PRCQ_TLC_3RD_PRG_FULL_PLN,          NF_NORMAL_CMD,  TRIG_CMD_WRITE,   INVALID_BIT(9),    0},
    /*  ADD 3 STAGE TLC 1ST PRG FOR XOR  */
    {FLASH_PRCQ_TLC_1ST_PRG_LOW_PAGE_FULL_PLN,         NF_NORMAL_CMD,  TRIG_CMD_WRITE,   INVALID_BIT(9),    0},
    {FLASH_PRCQ_TLC_1ST_PRG_MID_PAGE_FULL_PLN,         NF_NORMAL_CMD,  TRIG_CMD_WRITE,   INVALID_BIT(9),    0},
    {FLASH_PRCQ_TLC_1ST_PRG_UPP_PAGE_FULL_PLN,         NF_NORMAL_CMD,  TRIG_CMD_WRITE,   INVALID_BIT(9),    0},
    /*  COPY BACK, 15nm TSB is 2 PLN flash  */
    {FLASH_PRCQ_SLC_COPY_TO_SLC_FULL_PLN,              NF_NORMAL_CMD,  TRIG_CMD_WRITE,   INVALID_BIT(9),    0},
    {FLASH_PRCQ_1ST_SLC_COPY_TO_TLC_FULL_PLN,          NF_NORMAL_CMD,  TRIG_CMD_WRITE,   INVALID_BIT(9),    0},
    {FLASH_PRCQ_2ND_SLC_COPY_TO_TLC_FULL_PLN,          NF_NORMAL_CMD,  TRIG_CMD_WRITE,   INVALID_BIT(9),    0},
    {FLASH_PRCQ_3RD_SLC_COPY_TO_TLC_FULL_PLN,          NF_NORMAL_CMD,  TRIG_CMD_WRITE,   INVALID_BIT(9),    0},
//#ifdef TRI_STAGE_COPY
    {FLASH_PRCQ_1ST_SLC_COPY_TO_TLC_LOW_PAGE_FULL_PLN, NF_NORMAL_CMD,  TRIG_CMD_WRITE,   INVALID_BIT(9),    0},
    {FLASH_PRCQ_1ST_SLC_COPY_TO_TLC_MID_PAGE_FULL_PLN, NF_NORMAL_CMD,  TRIG_CMD_WRITE,   INVALID_BIT(9),    0},
    {FLASH_PRCQ_1ST_SLC_COPY_TO_TLC_UPP_PAGE_FULL_PLN, NF_NORMAL_CMD,  TRIG_CMD_WRITE,   INVALID_BIT(9),    0},
    
    {FLASH_PRCQ_2ND_SLC_COPY_TO_TLC_LOW_PAGE_FULL_PLN, NF_NORMAL_CMD,  TRIG_CMD_WRITE,   INVALID_BIT(9),    0},
    {FLASH_PRCQ_2ND_SLC_COPY_TO_TLC_MID_PAGE_FULL_PLN, NF_NORMAL_CMD,  TRIG_CMD_WRITE,   INVALID_BIT(9),    0},
    {FLASH_PRCQ_2ND_SLC_COPY_TO_TLC_UPP_PAGE_FULL_PLN, NF_NORMAL_CMD,  TRIG_CMD_WRITE,   INVALID_BIT(9),    0},
    
    {FLASH_PRCQ_3RD_SLC_COPY_TO_TLC_LOW_PAGE_FULL_PLN, NF_NORMAL_CMD,  TRIG_CMD_WRITE,   INVALID_BIT(9),    0},
    {FLASH_PRCQ_3RD_SLC_COPY_TO_TLC_MID_PAGE_FULL_PLN, NF_NORMAL_CMD,  TRIG_CMD_WRITE,   INVALID_BIT(9),    0},
    {FLASH_PRCQ_3RD_SLC_COPY_TO_TLC_UPP_PAGE_FULL_PLN, NF_NORMAL_CMD,  TRIG_CMD_WRITE,   INVALID_BIT(9),    0},
//#endif
    ...
    /* pio cmd, unit in DW*/
    {FLASH_PRCQ_TLC_READRETRY_PRE,             NF_PIO_CMD,        TRIG_CMD_OTHER,   INVALID_BIT(9),    0},
    {FLASH_PRCQ_TLC_READRETRY_ADJUSTMENT_CH0,  NF_PIO_CMD,        TRIG_CMD_OTHER,   INVALID_BIT(9),    0},
    {FLASH_PRCQ_TLC_READRETRY_ADJUSTMENT_CH1,  NF_PIO_CMD,        TRIG_CMD_OTHER,   INVALID_BIT(9),    0},
    {FLASH_PRCQ_TLC_READRETRY_ADJUSTMENT_CH2,  NF_PIO_CMD,        TRIG_CMD_OTHER,   INVALID_BIT(9),    0},
    {FLASH_PRCQ_TLC_READRETRY_ADJUSTMENT_CH3,  NF_PIO_CMD,        TRIG_CMD_OTHER,   INVALID_BIT(9),    0},
    {FLASH_PRCQ_TLC_READRETRY_EN,              NF_PIO_CMD,        TRIG_CMD_OTHER,   INVALID_BIT(9),    0},
...
GLOBAL MCU12_DRAM_TEXT U8 l_aQETable[] =
{
    ...
    */
    ...
    09h-01h-80h-Addrx5-DataIn-1Ah-->tCBSY1-->Finish
    1st Program middle page part with data in:
    09h-02h-80h-Addrx5-DataIn-1Ah-->tCBSY1-->Finish
    1st Program upper page part with data in:
    09h-03h-80h-Addrx5-DataIn-10h-->tCBSY1-->Finish
    */
    QE_GRP_ATTR(PRCQ_ONE_CYCLE_CMD)     |QE_INDEX(CQE1E_09),
    QE_GRP_ATTR(PRCQ_ONE_CYCLE_CMD)     |QE_INDEX(CQE1E_01),
    ...
    /* Two Physical Plane TLC 2nd Program with data in*/
    /*
    2nd Program lower page part with data in:
    0Dh-01h-80h-Addrx5-DataIn-1Ah-->tCBSY1-->Finish
    2nd Program middle page part with data in:
    0Dh-02h-80h-Addrx5-DataIn-1Ah-->tCBSY1-->Finish
    2nd Program upper page part with data in:
    0Dh-03h-80h-Addrx5-DataIn-10h-->tCBSY1-->Finish
    */
    QE_GRP_ATTR(PRCQ_ONE_CYCLE_CMD)     |QE_INDEX(CQE1E_0D),
    QE_GRP_ATTR(PRCQ_ONE_CYCLE_CMD)     |QE_INDEX(CQE1E_01),
    QE_GRP_ATTR(PRCQ_THREE_PHASE_CMD)   |QE_INDEX(CQE2E_1A80),
    QE_GRP_ATTR(PRCQ_FIVE_CYCLE_ADDR)   |QE_INDEX(ADDR0),
    QE_GRP_ATTR(PRCQ_DMA_WRITE)         |QE_INDEX(ADDR0),
    ...
    /* Two Physical Plane TLC 3rd Program with data in*/
    /*
    3rd Program lower page part with data in:
    01h-80h-Addrx5-DataIn-1Ah-->tCBSY1-->Finish
    3rd Program middle page part with data in:
    02h-80h-Addrx5-DataIn-1Ah-->tCBSY1-->Finish
    3rd Program upper page part with data in:
    03h-80h-Addrx5-DataIn-10h-->tCBSY1-->Finish
    */
    QE_GRP_ATTR(PRCQ_ONE_CYCLE_CMD)     |QE_INDEX(CQE1E_01),
    QE_GRP_ATTR(PRCQ_THREE_PHASE_CMD)   |QE_INDEX(CQE2E_1A80),
    QE_GRP_ATTR(PRCQ_FIVE_CYCLE_ADDR)   |QE_INDEX(ADDR0),
    ...
    */
    ...
    QE_GRP_ATTR(PRCQ_TWO_PHASE_CMD)     |QE_INDEX(CQE2E_E005),
    QE_GRP_ATTR(PRCQ_FIVE_CYCLE_ADDR)   |QE_INDEX(ADDR0),
    QE_GRP_ATTR(PRCQ_IDLE)              |QE_INDEX(1),   //15*4=60T@200M NFCLK
    QE_GRP_ATTR(PRCQ_DMA_READ)          |QE_INDEX(ADDR0),
    QE_GRP_ATTR(PRCQ_TWO_PHASE_CMD)     |QE_INDEX(CQE2E_E005),
    QE_GRP_ATTR(PRCQ_FIVE_CYCLE_ADDR)   |QE_INDEX(ADDR1),
    QE_GRP_ATTR(PRCQ_IDLE)              |QE_INDEX(1),
    ...
    /*
    1st Program lower page part with data in:
    09h-01h-80h-Addrx5P0-DataInP0-11h-->tCBSY1-->
    09h-01h-80h-Addrx5OpP1-DataInP1-1Ah-->tCBSY1-->Finish
    */
    /*
    1st Program middle page part with data in:
    09h-02h-80h-Addrx5P0-DataInP0-11h-->tCBSY1-->
    09h-02h-80h-Addrx5P1-DataInP1-1Ah-->tCBSY1-->Finish
    */
    /*
    1st Program upper page part with data in:
    09h-03h-80h-Addrx5P0-DataInP0-11h-->tCBSY1-->
    09h-03h-80h-Addrx5P1-DataInP1-10h-->tCBSY1-->Finish
    */
    ...
    //FLASH_PRCQ_TLC_1ST_PRG_MID_PAGE_2PLN
    QE_GRP_ATTR(PRCQ_ONE_CYCLE_CMD)     |QE_INDEX(CQE1E_09),
    QE_GRP_ATTR(PRCQ_ONE_CYCLE_CMD)     |QE_INDEX(CQE1E_02),
    QE_GRP_ATTR(PRCQ_THREE_PHASE_CMD)   |QE_INDEX(CQE2E_1180),
    #ifndef PATCH_HW_TLC_ROWADDR_SET//patch for tlc
    QE_GRP_ATTR(PRCQ_FIVE_CYCLE_ADDR)   |QE_INDEX(ADDR0),
    QE_GRP_ATTR(PRCQ_DMA_WRITE)         |QE_INDEX(ADDR0),
    #else
    ...
    //FLASH_PRCQ_TLC_1ST_PRG_UPP_PAGE_2PLN
    QE_GRP_ATTR(PRCQ_ONE_CYCLE_CMD)     |QE_INDEX(CQE1E_09),
    QE_GRP_ATTR(PRCQ_ONE_CYCLE_CMD)     |QE_INDEX(CQE1E_03),
    QE_GRP_ATTR(PRCQ_THREE_PHASE_CMD)   |QE_INDEX(CQE2E_1180),
    #ifndef PATCH_HW_TLC_ROWADDR_SET//patch for tlc
   ...
   //FLASH_PRCQ_TLC_2ND_PRG_LOW_PAGE_2PLN
    /*
    2nd Program lower page part with data in:
    0Dh-01h-80h-Addrx5P0-DataInP0-11h-->tCBSY1-->
    0Dh-01h-80h-Addrx5P1-DataInP1-1Ah-->tCBSY1-->Finish
    */
    /*
    2nd Program middle page part with data in:
    0Dh-02h-80h-Addrx5P0-DataInP0-11h-->tCBSY1-->
    0Dh-02h-80h-Addrx5P1-DataInP1-1Ah-->tCBSY1-->Finish
    */
    /*
    2nd Program upper page part with data in:
    0Dh-03h-80h-Addrx5P0-DataInP0-11h-->tCBSY1-->
    0Dh-03h-80h-Addrx5P1-DataInP1-10h-->tCBSY1-->Finish
    */
    //FLASH_PRCQ_TLC_2ND_PRG_LOW_PAGE_2PLN
    QE_GRP_ATTR(PRCQ_ONE_CYCLE_CMD)     |QE_INDEX(CQE1E_0D),
    QE_GRP_ATTR(PRCQ_ONE_CYCLE_CMD)     |QE_INDEX(CQE1E_01),
    ...
    //FLASH_PRCQ_TLC_2ND_PRG_MID_PAGE_2PLN
    QE_GRP_ATTR(PRCQ_ONE_CYCLE_CMD)     |QE_INDEX(CQE1E_0D),
    QE_GRP_ATTR(PRCQ_ONE_CYCLE_CMD)     |QE_INDEX(CQE1E_02),
    QE_GRP_ATTR(PRCQ_THREE_PHASE_CMD)   |QE_INDEX(CQE2E_1180),
    #ifndef PATCH_HW_TLC_ROWADDR_SET//patch for tlc
    ...
    //FLASH_PRCQ_TLC_2ND_PRG_UPP_PAGE_2PLN
    QE_GRP_ATTR(PRCQ_ONE_CYCLE_CMD)     |QE_INDEX(CQE1E_0D),
    QE_GRP_ATTR(PRCQ_ONE_CYCLE_CMD)     |QE_INDEX(CQE1E_03),
    QE_GRP_ATTR(PRCQ_THREE_PHASE_CMD)   |QE_INDEX(CQE2E_1180),
    #ifndef PATCH_HW_TLC_ROWADDR_SET//patch for tlc
    ...
    01h-80h-Addrx5P1-DataInP1-1Ah-->tCBSY1-->Finish
    */
    /*
    3rd Program middle page part with data in:
    ...
    */
    ...
    // A2 60 | Addr 5 |60| Addr 5 |30|BSY |
    // 06|ADD X5 |e0|Data pln 0|
    // 06|ADD X5 |e0|Data pln 1|   
    // A2 85|ADD[0] X 5 | Data pln 0 |11 | BSY| 85 |ADD[1] X 5 | Data pln 1 | 10| BSY |END
    QE_GRP_ATTR(PRCQ_ONE_CYCLE_CMD)     |QE_INDEX(CQE1E_A2),
    QE_GRP_ATTR(PRCQ_ONE_CYCLE_CMD)     |QE_INDEX(CQE1E_60),
    QE_GRP_ATTR(PRCQ_ROW_ADDR)          |QE_INDEX(ADDR0),
    QE_GRP_ATTR(PRCQ_TWO_PHASE_CMD)     |QE_INDEX(CQE2E_3060),
    ...
    //COPY TO ANOTHER SLC PAGE:ADDR2/3
    QE_GRP_ATTR(PRCQ_ONE_CYCLE_CMD)     |QE_INDEX(CQE1E_A2),
    QE_GRP_ATTR(PRCQ_TWO_PHASE_CMD)     |QE_INDEX(CQE2E_1185),
    QE_GRP_ATTR(PRCQ_FIVE_CYCLE_ADDR)   |QE_INDEX(ADDR2),
    QE_GRP_ATTR(PRCQ_READ_STATUS_EH)    |QE_INDEX(SQEE_2E78),
    QE_GRP_ATTR(PRCQ_ROW_ADDR)          |QE_INDEX(ADDR2),
    
    QE_GRP_ATTR(PRCQ_TWO_PHASE_CMD)     |QE_INDEX(CQE2E_1085),
    QE_GRP_ATTR(PRCQ_FIVE_CYCLE_ADDR)   |QE_INDEX(ADDR3),
    QE_GRP_ATTR(PRCQ_READ_STATUS_EH)    |QE_INDEX(SQEE_3E78),
    QE_GRP_ATTR(PRCQ_ROW_ADDR)          |QE_INDEX(ADDR2),
    QE_GRP_ATTR(PRCQ_READ_STATUS_EH)    |QE_INDEX(SQEE_3E78),
...
{
#ifndef BOOTLOADER
   // FLASH_PRCQ_TLC_READRETRY_PRE
    NF_RAW_TLC_CMD_READRETRYEN_L0,
    NF_RAW_TLC_CMD_READRETRYEN_L1,
    NF_RAW_TLC_CMD_READRETRYEN_L2,
    NF_RAW_TLC_CMD_READRETRYEN_L3,
    NF_RAW_TLC_CMD_READRETRYEN_L4,
    
    // FLASH_PRCQ_TLC_READRETRY_ADJUSTMENT_CH0, default value from table 
    RAW_PIO_CMD|PIO_CFG_VALUE(0x55),
    RAW_PIO_ADDR|PIO_CFG_VALUE(0x4),
    RAW_PIO_DATAOUT|PIO_CFG_VALUE(0x4),
    ...
    RAW_PIO_CMD|PIO_CFG_VALUE(0x55),
    RAW_PIO_ADDR|PIO_CFG_VALUE(0x8),
    RAW_PIO_DATAOUT|PIO_CFG_VALUE(0x4),

    RAW_PIO_CMD|PIO_CFG_VALUE(0x55),
    RAW_PIO_ADDR|PIO_CFG_VALUE(0x9),
    RAW_PIO_DATAOUT|PIO_CFG_VALUE(0x4),

    RAW_PIO_CMD|PIO_CFG_VALUE(0x55),
    RAW_PIO_ADDR|PIO_CFG_VALUE(0xA),
    RAW_PIO_DATAOUT|PIO_CFG_VALUE(0x4)|RAW_PIO_IO_LAST_PHS(1),
    ...
    // FLASH_PRCQ_READRETRY_PRE, FOR SLC
    NF_RAW_TLC_CMD_READRETRYEN_L0,
    NF_RAW_TLC_CMD_READRETRYEN_L1,
    NF_RAW_TLC_CMD_READRETRYEN_L2,
    NF_RAW_TLC_CMD_READRETRYEN_L3,
    ...
    RAW_PIO_CMD|PIO_CFG_VALUE(0x55),
    RAW_PIO_ADDR|PIO_CFG_VALUE(0xB),
    RAW_PIO_DATAOUT|PIO_CFG_VALUE(0x0),

    RAW_PIO_CMD|PIO_CFG_VALUE(0x55),
    RAW_PIO_ADDR|PIO_CFG_VALUE(0xD),
