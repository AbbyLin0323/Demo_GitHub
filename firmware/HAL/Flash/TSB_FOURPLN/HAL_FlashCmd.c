...
Others      : This file's flash cmd is for TSB MLC 4PLN chip
              mode 1 PLN read cmd.
Modify      :
20160321    abby      create
*******************************************************************************/
...
#ifndef BOOTLOADER
    /*  MLC FULL PLN cmd, 15nm TSB MLC is 4 PLN flash  */
...
#endif
    /* pio cmd, unit in DW*/
    {FLASH_PRCQ_READRETRY_PRE,             NF_PIO_CMD,     TRIG_CMD_OTHER,   INVALID_BIT(9),    0},
    {FLASH_PRCQ_READRETRY_ADJUSTMENT_CH0,  NF_PIO_CMD,     TRIG_CMD_OTHER,   INVALID_BIT(9),    0},
    {FLASH_PRCQ_READRETRY_ADJUSTMENT_CH1,  NF_PIO_CMD,     TRIG_CMD_OTHER,   INVALID_BIT(9),    0},
    {FLASH_PRCQ_READRETRY_ADJUSTMENT_CH2,  NF_PIO_CMD,     TRIG_CMD_OTHER,   INVALID_BIT(9),    0},
    {FLASH_PRCQ_READRETRY_ADJUSTMENT_CH3,  NF_PIO_CMD,     TRIG_CMD_OTHER,   INVALID_BIT(9),    0},
    {FLASH_PRCQ_READRETRY_EN,              NF_PIO_CMD,     TRIG_CMD_OTHER,   INVALID_BIT(9),    0},
...
GLOBAL MCU12_DRAM_TEXT U8 l_aQETable[] =
{
    ...
    QE_GRP_ATTR(PRCQ_READ_STATUS_EH)    |QE_INDEX(SQEE_3E78),
    QE_GRP_ATTR(PRCQ_ROW_ADDR)          |QE_INDEX(0x3),
    QE_GRP_ATTR(PRCQ_FINISH)            |QE_INDEX(END),         
...
{
    // FLASH_PRCQ_READRETRY_PRE, FOR MLC
    NF_RAW_CMD_READRETRYEN_L0,
    NF_RAW_CMD_READRETRYEN_L1,

    // FLASH_PRCQ_READRETRY_ADJUSTMENT_CH0
