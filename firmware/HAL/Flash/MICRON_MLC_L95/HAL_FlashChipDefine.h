...
#define FLASH_L95                      // only for flash-model or FlashChip notes.
...
#define LUN_POS_IN_ROW_ADDR         (BLK_POS_IN_ROW_ADDR + BLK_PER_PLN_BITS + 1)
...
#define EMPTY_THRD_FST_15K         (8956)   // 1024B + 2B(CRC) + 4B(LBA)/Per4K + 104B(ECC), default 99% => ((1024+2+128)*15 + 4*3)*8*0.99/15 = 9146.016
...
/*  scramble mask   */
#define SCRAMBLE_MSK_EN             (1)   //1- mask,disable scramble for MICRON flash

/*****************************/
/* Pair Page related */
/*****************************/
#define PAIR_PAGE_PER_BLK           (260)
#define PAIR_PAGE_PRG_MAX           (2)
#define PAIR_PAGE_INTERVAL_MAX      (6)  //max interval in low page and extra page
