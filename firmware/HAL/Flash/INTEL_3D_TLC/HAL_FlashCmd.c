...
GLOBAL MCU12_VAR_ATTR PRCQ_TABLE g_aPrcqTable[FLASH_PRCQ_CNT] =
{
    ...
    {FLASH_PRCQ_SLC_ERS_3PLN,                   NF_NORMAL_CMD,  TRIG_CMD_ERASE,   INVALID_BIT(9),    0},
    {FLASH_PRCQ_SLC_ERS_2PLN,                   NF_NORMAL_CMD,  TRIG_CMD_ERASE,   INVALID_BIT(9),    0},
    ...
    {FLASH_PRCQ_SLC_READ_3PLN,                  NF_NORMAL_CMD,  TRIG_CMD_READ,    INVALID_BIT(9),    0},
    {FLASH_PRCQ_SLC_READ_2PLN,                  NF_NORMAL_CMD,  TRIG_CMD_READ,    INVALID_BIT(9),    0},
    {FLASH_PRCQ_SLC_PRG_FULL_PLN,               NF_NORMAL_CMD,  TRIG_CMD_WRITE,   INVALID_BIT(9),    0},
    {FLASH_PRCQ_SLC_PRG_3PLN,                   NF_NORMAL_CMD,  TRIG_CMD_WRITE,   INVALID_BIT(9),    0},
    {FLASH_PRCQ_SLC_PRG_2PLN,                   NF_NORMAL_CMD,  TRIG_CMD_WRITE,   INVALID_BIT(9),    0},
    ...
    {FLASH_PRCQ_TLC_ERS_3PLN,                       NF_NORMAL_CMD,  TRIG_CMD_ERASE,   INVALID_BIT(9),    0},
    {FLASH_PRCQ_TLC_ERS_2PLN,                       NF_NORMAL_CMD,  TRIG_CMD_ERASE,   INVALID_BIT(9),    0},
    ...
    {FLASH_PRCQ_TLC_READ_3PLN,                      NF_NORMAL_CMD,  TRIG_CMD_READ,    INVALID_BIT(9),    0},
    {FLASH_PRCQ_TLC_READ_2PLN,                      NF_NORMAL_CMD,  TRIG_CMD_READ,    INVALID_BIT(9),    0},
    {FLASH_PRCQ_TLC_PRG_FULL_PLN,                   NF_NORMAL_CMD,  TRIG_CMD_WRITE,   INVALID_BIT(9),    0},
    {FLASH_PRCQ_TLC_PRG_3PLN,                       NF_NORMAL_CMD,  TRIG_CMD_WRITE,   INVALID_BIT(9),    0},
    {FLASH_PRCQ_TLC_PRG_2PLN,                       NF_NORMAL_CMD,  TRIG_CMD_WRITE,   INVALID_BIT(9),    0},
    ...
    {FLASH_PRCQ_TLC_PRG_3PLN_LOW_PG_NO_HIGH,        NF_NORMAL_CMD,  TRIG_CMD_WRITE,   INVALID_BIT(9),    0},
    {FLASH_PRCQ_TLC_PRG_2PLN_LOW_PG_NO_HIGH,        NF_NORMAL_CMD,  TRIG_CMD_WRITE,   INVALID_BIT(9),    0},
...
GLOBAL MCU12_DRAM_TEXT U8 l_aQETable[] =
{
    ...
    // 00 5x addr 05 | addr x 2 (col addr)|e0      | data (pln 0) | finish
    QE_GRP_ATTR(PRCQ_ONE_CYCLE_CMD)     |QE_INDEX(CQE1E_00),
    QE_GRP_ATTR(PRCQ_FIVE_CYCLE_ADDR)   |QE_INDEX(ADDR0),
    QE_GRP_ATTR(PRCQ_TWO_PHASE_CMD)     |QE_INDEX(CQE2E_E005),
    QE_GRP_ATTR(PRCQ_COL_ADDR)          |QE_INDEX(ADDR0),
    ...
    QE_GRP_ATTR(PRCQ_ONE_CYCLE_CMD)     |QE_INDEX(CQE1E_61), //pending
    QE_GRP_ATTR(PRCQ_ROW_ADDR)          |QE_INDEX(ADDR0),
    QE_GRP_ATTR(PRCQ_FINISH)            |QE_INDEX(END),
    ...
    QE_GRP_ATTR(PRCQ_ONE_CYCLE_CMD)     |QE_INDEX(CQE1E_DF),
    QE_GRP_ATTR(PRCQ_THREE_PHASE_CMD)   |QE_INDEX(CQE2E_1180),// LSB page
    QE_GRP_ATTR(PRCQ_FIVE_CYCLE_ADDR)   |QE_INDEX(ADDR0),
    QE_GRP_ATTR(PRCQ_DMA_WRITE)         |QE_INDEX(ADDR0),
    QE_GRP_ATTR(PRCQ_READ_STATUS_EH)    |QE_INDEX(SQEE_2E78),
    QE_GRP_ATTR(PRCQ_ROW_ADDR)          |QE_INDEX(ADDR0),
    ...
    QE_GRP_ATTR(PRCQ_THREE_PHASE_CMD)   |QE_INDEX(CQE2E_1180), //MSB page
    ...
    //FLASH_PRCQ_TLC_PRG_2PLN_LOW_PG_NO_HIGH
    QE_GRP_ATTR(PRCQ_ONE_CYCLE_CMD)     |QE_INDEX(CQE1E_DF),
    QE_GRP_ATTR(PRCQ_IDLE)              |QE_INDEX(1), 
    QE_GRP_ATTR(PRCQ_THREE_PHASE_CMD)   |QE_INDEX(CQE2E_1180),
    QE_GRP_ATTR(PRCQ_FIVE_CYCLE_ADDR)   |QE_INDEX(ADDR0),
    ...
    //FLASH_PRCQ_TLC_PRG_FULL_PLN_LOW_PG   (Need this cmd?)
    QE_GRP_ATTR(PRCQ_ONE_CYCLE_CMD)     |QE_INDEX(CQE1E_DF),
    QE_GRP_ATTR(PRCQ_THREE_PHASE_CMD)   |QE_INDEX(CQE2E_1180),
    QE_GRP_ATTR(PRCQ_FIVE_CYCLE_ADDR)   |QE_INDEX(ADDR0),
    QE_GRP_ATTR(PRCQ_DMA_WRITE)         |QE_INDEX(ADDR0),
