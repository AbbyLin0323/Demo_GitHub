...
#define FLASH_3D_MLC
//#define NVDDR                           // sync NVDDR: 10~100M
#define NVDDR2
...
/*  plane related */
#define PLN_PER_LUN_BITS            3
#define PLN_PER_LUN                 (1 << PLN_PER_LUN_BITS)   //8 plane

#define PHY_PLN_PER_LUN_BITS        2
...
#define RSV_BLK_PER_PLN             0   //pending

/*  page related  */
#define PG_PER_BLK_BITS             9                       //for L2 view, 512 page per blk
#define PG_PER_BLK                  (1 << PG_PER_BLK_BITS)  

#define PHY_PG_PER_BLK_BITS         10                      //1024 page
...
#define PHYPG_SZ_BITS               14                      //16KB, physical page size in 3D MLC
