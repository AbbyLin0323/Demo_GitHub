...
{
    CQE1E_EF,CQE1E_0D,CQE1E_FF,CQE1E_FC,
    CQE1E_90,CQE1E_00,CQE1E_30,CQE1E_60,
    CQE1E_D0,CQE1E_EE,CQE1E_3F,CQE1E_85,
    CQE1E_09,CQE1E_01,CQE1E_02,CQE1E_FA
}CQE1E_INDEX;
...
typedef enum _CQE2E_INDEX  
{
    ...
    CQE2E_3160,CQE2E_1581,CQE2E_1A80,CQE2E_E006
}CQE2E_INDEX;
...
typedef enum _PRCQ_TYPE 
{
    ...
    /*  MLC 1PLN cmd  */
    NF_PRCQ_ERS_1PLN,
    NF_PRCQ_READ_1PLN,  //read low page only for 1 plane
    
    NF_PRCQ_PRG_1PLN,
    NF_PRCQ_PRG_1PLN_LOW_PG_NO_HIGH,
    NF_PRCQ_CHANGEREADCOLUM_1PLN,
#ifndef BOOTLOADER   
    NF_PRCQ_ERS_FULL_PLN,
    NF_PRCQ_READ_FULL_PLN,
    NF_PRCQ_PRG_FULL_PLN,
    NF_PRCQ_PRG_FULL_PLN_LOW_PG_NO_HIGH,
    NF_PRCQ_PRG_FULL_PLN_LOW_PG,
    NF_PRCQ_GETFEATURE,
...
/*  To be compatible with TLC, for compile only */
...
#define NF_PRCQ_TLC_1ST_PRG_LOW_PAGE_FULL_PLN   NF_PRCQ_PRG_FULL_PLN
#define NF_PRCQ_TLC_2ND_PRG_LOW_PAGE_FULL_PLN   NF_PRCQ_PRG_FULL_PLN
#define NF_PRCQ_TLC_3RD_PRG_LOW_PAGE_FULL_PLN   NF_PRCQ_PRG_FULL_PLN
