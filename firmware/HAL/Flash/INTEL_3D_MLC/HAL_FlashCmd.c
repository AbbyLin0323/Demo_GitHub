...
{
    /* normal cmd's */
    {NF_PRCQ_RESET,                         NF_NORMAL_CMD,  TRIG_CMD_OTHER,   INVALID_BIT(9),    0},
    {NF_PRCQ_SYNC_RESET,                    NF_NORMAL_CMD,  TRIG_CMD_OTHER,   INVALID_BIT(9),    0},
    {NF_PRCQ_RESET_LUN,                     NF_NORMAL_CMD,  TRIG_CMD_OTHER,   INVALID_BIT(9),    0},
    {NF_PRCQ_READID,                        NF_NORMAL_CMD,  TRIG_CMD_OTHER,   INVALID_BIT(9),    0},
    {NF_PRCQ_SETFEATURE,                    NF_NORMAL_CMD,  TRIG_CMD_WRITE,   INVALID_BIT(9),    0},
    /*  MLC 1PLN cmd  */
    {NF_PRCQ_ERS_1PLN,                      NF_NORMAL_CMD,  TRIG_CMD_ERASE,   INVALID_BIT(9),    0},
    {NF_PRCQ_READ_1PLN,                     NF_NORMAL_CMD,  TRIG_CMD_READ,    INVALID_BIT(9),    0},
    {NF_PRCQ_PRG_1PLN,                      NF_NORMAL_CMD,  TRIG_CMD_WRITE,   INVALID_BIT(9),    0},
    {NF_PRCQ_PRG_1PLN_LOW_PG_NO_HIGH,       NF_NORMAL_CMD,  TRIG_CMD_WRITE,   INVALID_BIT(9),    0},
    {NF_PRCQ_CHANGEREADCOLUM_1PLN,          NF_NORMAL_CMD,  TRIG_CMD_READ,    INVALID_BIT(9),    0},
#ifndef BOOTLOADER
    /*  MLC FULL PLN cmd, L95 MLC is 2 PLN flash  */
    {NF_PRCQ_ERS_FULL_PLN,                  NF_NORMAL_CMD,  TRIG_CMD_ERASE,   INVALID_BIT(9),    0},
    {NF_PRCQ_READ_FULL_PLN,                 NF_NORMAL_CMD,  TRIG_CMD_READ,    INVALID_BIT(9),    0},
    {NF_PRCQ_PRG_FULL_PLN,                  NF_NORMAL_CMD,  TRIG_CMD_WRITE,   INVALID_BIT(9),    0},
    {NF_PRCQ_PRG_FULL_PLN_LOW_PG_NO_HIGH,   NF_NORMAL_CMD,  TRIG_CMD_WRITE,   INVALID_BIT(9),    0},
    {NF_PRCQ_PRG_FULL_PLN_LOW_PG,           NF_NORMAL_CMD,  TRIG_CMD_WRITE,   INVALID_BIT(9),    0},
    {NF_PRCQ_GETFEATURE,                    NF_NORMAL_CMD,  TRIG_CMD_OTHER,   INVALID_BIT(9),    0},
    {NF_PRCQ_CHANGEREADCOLUM_FULL_PLN,      NF_NORMAL_CMD,  TRIG_CMD_READ,    INVALID_BIT(9),    0},
    {NF_PRCQ_READ_STS_ENHANCE_1PLN,         NF_NORMAL_CMD,  TRIG_CMD_OTHER,   INVALID_BIT(9),    0}, 
#endif

    /* pio cmd's bsCmdDepth area is initialize when compile, unit by DW*/
    {NF_PRCQ_PIO_SETFEATURE,                NF_PIO_CMD,     TRIG_CMD_OTHER,   INVALID_BIT(9),    0},
    {NF_PRCQ_PIO_SETFEATURE_EX,             NF_PIO_CMD,     TRIG_CMD_OTHER,   INVALID_BIT(9),    0}
};
...
GLOBAL MCU12_DRAM_TEXT U8 l_aQETable[] =
{
    ...
    // NF_RCMD_INDEX_PRG_1PLN, LOW PAGE + UPP PAGE CMD
    QE_GRP_ATTR(PRCQ_THREE_PHASE_CMD)   |QE_INDEX(CQE2E_1080),
    QE_GRP_ATTR(PRCQ_FIVE_CYCLE_ADDR)   |QE_INDEX(ADDR0),
    QE_GRP_ATTR(PRCQ_DMA_WRITE)         |QE_INDEX(ADDR0),
    QE_GRP_ATTR(PRCQ_READ_STATUS_EH)    |QE_INDEX(SQEE_2E78),//Don't change to 3E78 to avoid cmd insert
    QE_GRP_ATTR(PRCQ_ROW_ADDR)          |QE_INDEX(ADDR0),
    ...
    // NF_PRCQ_PRG_1PLN_LOW_PG_NO_HIGH, LOW PAGE WITHOUT HIGH
    QE_GRP_ATTR(PRCQ_THREE_PHASE_CMD)   |QE_INDEX(CQE2E_1080),
    QE_GRP_ATTR(PRCQ_FIVE_CYCLE_ADDR)   |QE_INDEX(ADDR0),
    QE_GRP_ATTR(PRCQ_DMA_WRITE)         |QE_INDEX(ADDR0),
    QE_GRP_ATTR(PRCQ_READ_STATUS_EH)    |QE_INDEX(SQEE_3E78),
    ...
    // NF_PRCQ_READ_2PLN, actual 4 PLN, LOW PAGE + UPP PAGE/DOUBLE LOW PAGE WITHOUT HIGH
    // LOW page
    ...
    QE_GRP_ATTR(PRCQ_FIVE_CYCLE_ADDR)   |QE_INDEX(ADDR2),
    QE_GRP_ATTR(PRCQ_TWO_PHASE_CMD)     |QE_INDEX(CQE2E_E005),
    QE_GRP_ATTR(PRCQ_COL_ADDR)          |QE_INDEX(ADDR2),
    QE_GRP_ATTR(PRCQ_IDLE)              |QE_INDEX(1),
    QE_GRP_ATTR(PRCQ_DMA_READ)          |QE_INDEX(ADDR2),

    QE_GRP_ATTR(PRCQ_ONE_CYCLE_CMD)     |QE_INDEX(CQE1E_00),
    QE_GRP_ATTR(PRCQ_FIVE_CYCLE_ADDR)   |QE_INDEX(ADDR3),
    QE_GRP_ATTR(PRCQ_TWO_PHASE_CMD)     |QE_INDEX(CQE2E_E005),
    QE_GRP_ATTR(PRCQ_COL_ADDR)          |QE_INDEX(ADDR3),
    QE_GRP_ATTR(PRCQ_IDLE)              |QE_INDEX(1),
    QE_GRP_ATTR(PRCQ_DMA_READ)          |QE_INDEX(ADDR3),
    QE_GRP_ATTR(PRCQ_FINISH)            |QE_INDEX(END),
  
    // NF_PRCQ_PRG_2PLN, actual 4 PLN, LOW PAGE + UPP PAGE/DOUBLE LOW PAGE WITHOUT HIGH
    // LSB page
    ...
    QE_GRP_ATTR(PRCQ_THREE_PHASE_CMD)   |QE_INDEX(CQE2E_1180),
    QE_GRP_ATTR(PRCQ_FIVE_CYCLE_ADDR)   |QE_INDEX(ADDR6),
    QE_GRP_ATTR(PRCQ_DMA_WRITE)         |QE_INDEX(ADDR6),
    QE_GRP_ATTR(PRCQ_READ_STATUS_EH)    |QE_INDEX(SQEE_2E78),
    QE_GRP_ATTR(PRCQ_ROW_ADDR)          |QE_INDEX(ADDR6),
    
    QE_GRP_ATTR(PRCQ_THREE_PHASE_CMD)   |QE_INDEX(CQE2E_1080),
    QE_GRP_ATTR(PRCQ_FIVE_CYCLE_ADDR)   |QE_INDEX(ADDR7),
    QE_GRP_ATTR(PRCQ_DMA_WRITE)         |QE_INDEX(ADDR7),
    /* read status of each plane */
    QE_GRP_ATTR(PRCQ_READ_STATUS_EH)    |QE_INDEX(SQEE_3E78),
    QE_GRP_ATTR(PRCQ_ROW_ADDR)          |QE_INDEX(ADDR4),
    QE_GRP_ATTR(PRCQ_READ_STATUS_EH)    |QE_INDEX(SQEE_3E78),
    ...
    QE_GRP_ATTR(PRCQ_ROW_ADDR)          |QE_INDEX(ADDR6),
    QE_GRP_ATTR(PRCQ_READ_STATUS_EH)    |QE_INDEX(SQEE_3E78),
    QE_GRP_ATTR(PRCQ_ROW_ADDR)          |QE_INDEX(ADDR7),
    QE_GRP_ATTR(PRCQ_FINISH)            |QE_INDEX(END),

    // NF_PRCQ_PRG_FULL_PLN_LOW_PG_NO_HIGH, actual 4 PLN, LOW PAGE WITHOUT HIGH          
    QE_GRP_ATTR(PRCQ_THREE_PHASE_CMD)   |QE_INDEX(CQE2E_1180),
    QE_GRP_ATTR(PRCQ_FIVE_CYCLE_ADDR)   |QE_INDEX(ADDR0),
    QE_GRP_ATTR(PRCQ_DMA_WRITE)         |QE_INDEX(ADDR0),
    QE_GRP_ATTR(PRCQ_READ_STATUS_EH)    |QE_INDEX(SQEE_2E78),    
    ...
    QE_GRP_ATTR(PRCQ_DMA_WRITE)         |QE_INDEX(ADDR2),
    QE_GRP_ATTR(PRCQ_READ_STATUS_EH)    |QE_INDEX(SQEE_2E78),
    QE_GRP_ATTR(PRCQ_ROW_ADDR)          |QE_INDEX(0x2),
    ...
    //NF_PRCQ_PRG_FULL_PLN_LOW_PG, actual 4 PLN, LOW PAGE DATA + UPP PAGE CMD
    QE_GRP_ATTR(PRCQ_THREE_PHASE_CMD)   |QE_INDEX(CQE2E_1180),
    QE_GRP_ATTR(PRCQ_FIVE_CYCLE_ADDR)   |QE_INDEX(ADDR0),
    QE_GRP_ATTR(PRCQ_DMA_WRITE)         |QE_INDEX(ADDR0),
    QE_GRP_ATTR(PRCQ_READ_STATUS_EH)    |QE_INDEX(SQEE_2E78),    
    ...
    QE_GRP_ATTR(PRCQ_ROW_ADDR)          |QE_INDEX(ADDR3),
    //UPP page
    QE_GRP_ATTR(PRCQ_TWO_PHASE_CMD)     |QE_INDEX(CQE2E_1180),
    QE_GRP_ATTR(PRCQ_FIVE_CYCLE_ADDR)   |QE_INDEX(ADDR4),
    QE_GRP_ATTR(PRCQ_READ_STATUS_EH)    |QE_INDEX(SQEE_2E78),    
    QE_GRP_ATTR(PRCQ_ROW_ADDR)          |QE_INDEX(ADDR4),
...
void MCU12_DRAM_TEXT HAL_NfcPrcqInit(void)
{
    ...
    for (ucCmdCodeIndex = 0; ucCmdCodeIndex < NF_PRCQ_NON_PIO_NUM; ucCmdCodeIndex++)
    {
        do
        {
    ...
    for (ucCmdCodeIndex = NF_PRCQ_NON_PIO_NUM; ucCmdCodeIndex < NF_PRCQ_CNT; ucCmdCodeIndex++)
    {
        do
        {
