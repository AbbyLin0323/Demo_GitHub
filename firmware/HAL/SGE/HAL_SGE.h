...
#define SGE_DEBUG_HID_CHAIN_NUM 0x10000
#define SGE_DEBUG_DRAM_TRANS 0x10100
#define SGE_DEBUG_OTFB_TRANS 0x10200
#define SGE_DEBUG_OTFB_ACTIVE_BITMAP 0x10300

#define PUNUM_PER_SGQ_STATUS_REG     (32 / NFCQ_DEPTH_TOTAL)
...
//******************SGE debug Reg relate structure start*********//
typedef union _SGE_OTFB_TIG_STATUS_
{
    struct{
    U32 bsRes0               :8;
    U32 bsTiggerPUID         :6;
    ...
    U32 bsTiggerLen          :4;
    U32 bsRes2               :4;
    U32 bsCurrentTiggerWR    :1;   
    U32 bsErr                :1;   
    U32 bsTriggerByOtfb      :1;
    U32 bsRes3               :5;
    };
    U32 ulValue;
}SGE_OTFB_TIG_STATUS;

typedef union _SGE_HID_CHAIN_NUM_
{
    struct{
    U32 bsHWFinishedChainCnt  :16;   
    U32 bsFWConfigChainCnt    :15;  
    U32 bsValid               :1;
    };
    U32 ulValue;
}SGE_HID_CHAIN_NUM;

typedef union _SGE_OTFB_TRANS_ENG_
{
    struct{
    U32 bsRes0               :15;   
    U32 bsTXOnGoing          :1;  
...
typedef union _SGE_DRAM_TRANS_ENG_
{
    struct{
    U32 bsRes0               :13;   
    U32 bsTXOnGoing          :1;  
...
//******************SGE debug Reg relate structure End*********//
...
Bit     Attribute   Default Description                                                     Mnemonic
31:24  Reserved    0       Reserved                                                        RSV1
...
#define rSgeDebugInput   (*(volatile U32 *)(REG_BASE_SGE + 0x64))
#define rSgeDebugOutput0   (*(volatile U32 *)(REG_BASE_SGE + 0x68))
#define rSgeDebugOutput1   (*(volatile U32 *)(REG_BASE_SGE + 0x6C))
#define rSgeDebugOutput2   (*(volatile U32 *)(REG_BASE_SGE + 0x70))
#define rSgeDebugOutput3   (*(volatile U32 *)(REG_BASE_SGE + 0x74))

#define rSgqStatusP1Addr     (REG_BASE_SGE + 0x44)
#define rSgqStatusP2Addr     (REG_BASE_SGE + 0xB4)
...
BOOL HAL_SgqBuildEntry(U8 HID, U16 FirstHsgId, U8 PU, U8 ucLun, BOOL bWriteEn);
...
BOOL HAL_IsSGEIdle(void);
void HAL_SGEReset(void);
void HAL_SGEOTFBMapReset(void);
