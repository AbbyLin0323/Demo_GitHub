...
void DMAE_ModelProcessCmdEntry(U8 ucCMDID)
{
    ...
    case DMAE_SEL_AREA_DRAM:
        ulSrcAddr = tCurCmdEntry.ulSrcAddr - DRAM_START_ADDRESS;//get relative address
        Comm_ReadDram(ulSrcAddr, ulLenDW, l_paDmaeTempBuffer[ucCMDID]);
        break;

    case DMAE_SEL_AREA_OTFB:
        ulSrcAddr = tCurCmdEntry.ulSrcAddr - OTFB_START_ADDRESS;//get relative address
    ...
    {
    case DMAE_SEL_AREA_DRAM:
        ulDesAddr = tCurCmdEntry.ulDesAddr - DRAM_START_ADDRESS;//get relative address
        Comm_WriteDram(ulDesAddr, ulLenDW, l_paDmaeTempBuffer[ucCMDID]);
        break;

    case DMAE_SEL_AREA_OTFB:
        ulDesAddr = tCurCmdEntry.ulDesAddr - OTFB_START_ADDRESS;//get relative address
