...
BOOL BootRegWrite(U32 regaddr, U32 regvalue, U32 len)
{
    ...
    if(regaddr >= (U32)(&rGLB_24) && regaddr < ((U32)(&rGLB_24)+sizeof(U32)))
    {
        bRetFlag = TRUE;
    }
    if(regaddr >= (U32)(&rGLB_44) && regaddr < ((U32)(&rGLB_44)+sizeof(U32)))
    {
        ulRegValTemp = regvalue;
        tGlobalMcu = *((GLB_REG_MCU *)&ulRegValTemp);
        Comm_ReadReg((U32)&rGLB_44, 1, (U32 *)&tGlobalMcuLocal);
#if 0
    ...
    if(regaddr >= (U32)(&rGLB_1C) && regaddr < ((U32)(&rGLB_1C)+sizeof(U32)))
    {
         Comm_ReadReg((U32)&rGLB_44, 1, (U32 *)&tGlobalMcuLocal);
         ulRegValTemp = regvalue;
...
void InitCostumHwModel(XTMP_params p)
{
    ...
    //mcu0 boot mcu1/2
    InsertRegHandleCnf((U32)(&rGLB_24), (U32)(&rGLB_24)+sizeof(U32)-1, NULL, (regWriteHandler)BootRegWrite); 
    InsertRegHandleCnf((U32)(&rGLB_44), (U32)(&rGLB_44)+sizeof(U32)-1, NULL, (regWriteHandler)BootRegWrite); 
    InsertRegHandleCnf((U32)(&rGLB_1C), (U32)(&rGLB_1C)+sizeof(U32)-1, NULL, (regWriteHandler)BootRegWrite); 
...
#define LOAD_ELF_PATH_MCU0 \
    "D:\\Xplorer-6.0.1-workspaces\\VT3514_BootLoader\\bin\\rfviatieloop16\\release\\VT3514_BootLoader" //reviatie_loop16parity WholeChip_Mcu0
#define LOAD_ELF_PATH_MCU1 \
    "D:\\Xplorer-6.0.1-workspaces\\WholeChip_Mcu12\\bin\\rfviatieloop16\\release\\WholeChip_Mcu12" //reviatie_loop16parity
#define LOAD_ELF_PATH_MCU2 LOAD_ELF_PATH_MCU1
#else
#define LOAD_ELF_PATH_MCU1 \
    "c:\\usr\\xtensa\\Xplorer-5.0.5-workspaces\\workspace\\MixVector\\bin\\reviatie_loop16parity\\Release\\MixVector"
#endif
...
int XTMP_main(int argc, char **argv)
{
    ...
    *(u32 *)(g_pIsramBaseAddr[0] + ISRAM_REST_VECT_OFFSET) = DEAD_LOOP_INS;
    ...
    //set mcu0 boot from rom, mcu1/2 boot from isram
