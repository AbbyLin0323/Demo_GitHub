...
#ifdef VT3514_C0 // this module only supported in C0 design
...
LOCAL MCU12_VAR_ATTR volatile EM_SEED_AREA *l_pEmSeedArea;
...
void HAL_EMInit(U8 ucKeySizeParam, U8 ucEmMode, const U32 *pIV)
{
    ...
    //init FW variable
    l_pEmSeedArea = (volatile EM_SEED_AREA *)EM_LBA_BASE;
