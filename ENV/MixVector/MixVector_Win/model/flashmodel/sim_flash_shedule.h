...
#define PHY_PAGE_PER_LOGIC_PAGE (PAGE_PER_WL*PLN_PER_PU)
...
typedef struct _ST_FLASH_CMD_PARAM
{
    ...
    U32 bsTrigOmEn:1;
    U32 bsPuEccMsk:1;    // set - mask = disable ECC. added by jasonguo 20140815
    U32 bsFirstByteCheckEn:1; // valid only in VT3514 C0
...
#ifdef VT3514_C0
    FIRST_BYTE_ENTRY *pFirstByteEntry;
#endif
    U32 buffMapValue;

    ST_FLASH_PAGE_REQ_INFO phy_page_req[PHY_PAGE_PER_LOGIC_PAGE];
}ST_FLASH_CMD_PARAM;
