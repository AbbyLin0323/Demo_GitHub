...
/*
   Figure 272 每 FIS type value assignments

   27h Register Host to Device FIS
   34h Register Device to Host FIS
   39h DMA Activate FIS 每 Device to Host
   41h DMA Setup FIS 每 Bi-directional
   46h Data FIS 每 Bi-directional
   58h BIST Activate FIS 每 Bi-directional
   5Fh PIO Setup FIS 每 Device to Host
   A1h Set Device Bits FIS 每 Device to Host
