...
#define BUSY_TIME_BUS_TRANSFER         ((23.1*HCLK_CYCLE_COUNT_PER_US)*(1<<(PIPE_PG_SZ_BITS - NF_4K_BITS))) //  32us per 4K.   6006   

#else ifdef HCLK_300M_TOGGLE_75M
//#define FLASH_CONFIG_TIMER_INTERVAL    5
#define HCLK_CYCLE_COUNT_PER_US         300
#define BUSY_TIME_BUS_TRANSFER          ((31*HCLK_CYCLE_COUNT_PER_US)*(1<<(PIPE_PG_SZ_BITS - NF_4K_BITS))) //  32us per 4K. 
#endif
...
#define BUSY_TIME_DEV_TO_HOST_PER_BYTE         (BUSY_TIME_DEV_TO_HOST_PER_BUF/BUF_SIZE)
...
#define BUSY_TIME_HOST_TO_DEV_PER_BYTE         (BUSY_TIME_HOST_TO_DEV_PER_BUF/BUF_SIZE)
/////time param end
 ...
 */
#define FIRMWARE_LogInfo(format, ...) SystemStatisticRecord(format, __VA_ARGS__)
