...
volatile HCT_CONTROL_REG *g_pHCTControlReg = 0;
...
#else
        memcpy((void*)ulDeviceAddr, (void*)ullHostAddr.QuadPart, l_pFCQAddr->bsLength * 4);
#endif
...
#ifdef HOST_NVME
        NVME_FillHostCmdTable(l_pFCQAddr);
#endif
...
#else
    memcpy((void*)ullHostAddr.QuadPart, (void*)ulDeviceAddr, pWBQ->bsLength * sizeof(U32));
#endif
