/* This linker script generated from xt-genldscripts.tpp for LSP VT3533_A0_FW_MCU2_LSP */
...
MEMORY
{
  ...
  iram0_text_seg :                    	org = 0x20000700, len = 0xF900
  sram_mcu2_data_text_seg :           	org = 0x400A0000, len = 0x14000
}
...
_memmap_seg_iram0_text_max   = 0x20010000;
_memmap_seg_sram_mcu2_data_text_start = 0x400a0000;
_memmap_seg_sram_mcu2_data_text_max   = 0x400b4000;
...
SECTIONS
{
  ...
  } >sram_mcu2_data_text_seg :sram_mcu2_data_text_phdr

  .mcu2dram.data : ALIGN(4)
  {
    _mcu2dram_data_start = ABSOLUTE(.);
    *(.mcu2dram.data)
    _mcu2dram_data_end = ABSOLUTE(.);
  } >sram_mcu2_data_text_seg :sram_mcu2_data_text_phdr
  ...
  .mcu2dram.text : ALIGN(4)
  {
    ...
    *(.mcu2dram.literal .mcu2dram.text)
    ...
    _memmap_seg_sram_mcu2_data_text_end = ALIGN(0x8);
  } >sram_mcu2_data_text_seg :sram_mcu2_data_text_phdr
  .debug  0 :  { *(.debug) }
  .line  0 :  { *(.line) }
