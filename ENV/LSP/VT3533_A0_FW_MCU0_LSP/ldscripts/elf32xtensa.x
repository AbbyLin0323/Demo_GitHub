/* This linker script generated from xt-genldscripts.tpp for LSP VT3533_A0_FW_MCU0_LSP */
...
MEMORY
{
  ...
  iram0_text_seg :                    	org = 0x20000700, len = 0x9900
  sram_mcu0_data_text_seg :           	org = 0x40049000, len = 0xF000
  sram_mcu0_entrance_lit_seg :        	org = 0x40400000, len = 0x10
  sram_mcu0_entrance_text_seg :       	org = 0x40400010, len = 0x10
  sram_mcu0_head_infos_seg :          	org = 0x40400020, len = 0x30
  sram_mcu1_alloc_buff_seg :          	org = 0x40400050, len = 0x13BFFFB0
}
...
_memmap_seg_iram0_text_max   = 0x2000a000;
_memmap_seg_sram_mcu0_data_text_start = 0x40049000;
_memmap_seg_sram_mcu0_data_text_max   = 0x40058000;
_memmap_seg_sram_mcu0_entrance_lit_start = 0x40400000;
_memmap_seg_sram_mcu0_entrance_lit_max   = 0x40400010;
_memmap_seg_sram_mcu0_entrance_text_start = 0x40400010;
_memmap_seg_sram_mcu0_entrance_text_max   = 0x40400020;
_memmap_seg_sram_mcu0_head_infos_start = 0x40400020;
_memmap_seg_sram_mcu0_head_infos_max   = 0x40400050;
_memmap_seg_sram_mcu1_alloc_buff_start = 0x40400050;
_memmap_seg_sram_mcu1_alloc_buff_max   = 0x54000000;
...
SECTIONS
{
  ...
  .mcu0dram.text : ALIGN(4)
  {
    ...
    *(.mcu0dram.literal .mcu0dram.text)
  ...
  .mcu0headinfos.text : ALIGN(4)
  {
    _mcu0headinfos_text_start = ABSOLUTE(.);
    *(.mcu0headinfos.literal .mcu0headinfos.text)
    _mcu0headinfos_text_end = ABSOLUTE(.);
    _memmap_seg_sram_mcu0_head_infos_end = ALIGN(0x8);
  } >sram_mcu0_head_infos_seg :sram_mcu0_head_infos_phdr

  .mcu0head.text : ALIGN(4)
  {
    _mcu0head_text_start = ABSOLUTE(.);
    *(.mcu0head.literal .mcu0head.text)
    _mcu0head_text_end = ABSOLUTE(.);
    _memmap_seg_sram_mcu1_alloc_buff_end = ALIGN(0x8);
  } >sram_mcu1_alloc_buff_seg :sram_mcu1_alloc_buff_phdr
  .debug  0 :  { *(.debug) }
  .line  0 :  { *(.line) }
