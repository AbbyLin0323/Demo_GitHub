...
#ifdef XOR_ENABLE
// 4 * 8KB-OtfbBuf Per CH, total 4CH * 32KB = 128KB
#define ON_THE_FLY_TOTAL_SIZE       (0x20000)
#define ON_THE_FLY_PER_CH_SIZE      (0x8000)
#else
// 8 * 8KB-OtfbBuf Per CH, total 4CH * 64KB = 256KB
#define ON_THE_FLY_TOTAL_SIZE       (0x40000)
#define ON_THE_FLY_PER_CH_SIZE      (0x10000)
#endif
...
void SGE_OtfbToHost(U8 ucPhyPU ,U8 ucLun, U8 ucLevel, U32 bNfcInjErr); // updated by jasonguo 20140815
