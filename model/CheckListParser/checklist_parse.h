...
typedef enum _FLASH_ERR_PARAM
{
    INTERNAL_FLASH_PARAM = 1,
    EXTERNAL_FLASH_PARAM,
    SPOR_LAST_PAGE_UECC_FLASH_PARAM,
    SPOR_PAIR_PAGE_UECC_FLASH_PARAM,
}FLASH_ERR_PARAM;
...
typedef enum _ACTION_TYPE
{
    ...
    ACT_TYPE_SECURITY_LOCK_CHECK,
    ACT_TYPE_SECURITY_ULOCK_CHECK,
    ACT_TYPE_SECURITY_FREEZE_CHECK,
    ACT_TYPE_SECURITY_ENABLE_CHECK,
    ACT_TYPE_FW_UPDATE,
    ACT_TYPE_EXIT,
    ACT_TYPE_SET_ERASECNT,
    ACT_TYPE_SET_FLASH_ERR_RATE,
    ACT_TYPE_NVME_WRITE_ZERO,
    ACT_TYPE_CMD_TYPE,
    ACT_TYPE_ALL,
}ACTION_TYPE;
...
typedef struct _ERASECNT_SETTING
{
...
typedef struct _FLASH_ERR_RATE
{
...
typedef struct _ACTION
{
    ...
    U16 HSCmdId;
    ERASECNT_SETTING m_FlashEraseCntParam;
    FLASH_ERR_RATE m_FlashErrRate;
    char ProtocolType[255];
...
static ERR_TYPE_DESC ERR_TYPE_LIB[] =
{
    ...
    {NF_ERR_TYPE_DCRC, "CRC"},
    {0xFF,"END"},
};

typedef struct _HSRW_CMD_TYPE_DESC
{
    HSRW_CMD_TYPE CmdPrtType;
    char* CmdPrtDesc;

}HSRW_CMD_TYPE_DESC;

static HSRW_CMD_TYPE_DESC HSRW_CMD_TYPE_LIB[] =
{
    { HSRW_CMD_TYPE_NCQ, "NCQ" },
    { HSRW_CMD_TYPE_DMA, "DMA" },
    { HSRW_CMD_TYPE_PIO, "PIO" },
    { HSRW_CMD_TYPE_ALL, "END" },
};
...
static ACTION_TYPE_DESC ACTION_TYPE_LIB[] =
{
    ...
    {ACT_TYPE_INJECT_CRCERR,"InjectCRCError"},
    ...
    { ACT_TYPE_FW_UPDATE, "FW_Update" },
    {ACT_TYPE_SECURITY_LOCK_CHECK,"SecurityLockCheck"},
    {ACT_TYPE_SECURITY_ULOCK_CHECK,"SecurityUnlockCheck"},
    {ACT_TYPE_SECURITY_FREEZE_CHECK,"SecurityFreezeCheck"},
    {ACT_TYPE_SECURITY_ENABLE_CHECK,"SecurityEnableCheck"},
    {ACT_TYPE_EXIT,"Exit"},
    {ACT_TYPE_SET_ERASECNT, "EraseCnt"},
    {ACT_TYPE_SET_FLASH_ERR_RATE, "FlashErrRate"},
    {ACT_TYPE_NVME_WRITE_ZERO, "NVMeWriteZeroTest"},

    {ACT_TYPE_CMD_TYPE,"CMD_TYPE"},
    {ACT_TYPE_ALL,"END"},
};
...
extern U32 g_InjCRCErrHead;
extern U32 g_InjCRCErrTail;
extern FLASH_ERR_PARAM g_InjErrParamType;
