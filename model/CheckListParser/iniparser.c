...
void Parse_IdentifyData(U16* pBuffer)
{
    ...
    U16 bitIndex = 15;
    BOOL bHex = FALSE;
    char *pStrLogFloder = SIM_GetLogFileFloder();
    char strIdfyInfoFile[] = "\\special_cmd_list\\IdfyInfo.txt";
    char file_name[256] = {0};
    char file_name_dst[256] = {0};

    sprintf(file_name, "%s%s", l_strCheckListFolder, strIdfyInfoFile);
    sprintf(file_name_dst, "%s\\VT3514_IdfyInfo.txt", pStrLogFloder);
