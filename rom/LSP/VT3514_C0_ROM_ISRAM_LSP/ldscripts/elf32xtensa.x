/* This linker script generated from xt-genldscripts.tpp for LSP D:/workspace/VT3514_C0_ROM_ISRAM_LSP/RF-2014.1/rfviatieloop16/VT3514_C0_ROM_ISRAM_LSP */
...
MEMORY
{
  ...
  iram0_text_seg :                    	org = 0x20000900, len = 0x6000
  iram0_test_lit_seg :                	org = 0x20006900, len = 0x10
  iram0_test_seg :                    	org = 0x20006910, len = 0x1400
  sram_mcu0_entrance_lit_seg :        	org = 0x40048000, len = 0x10
  sram_mcu0_entrance_text_seg :       	org = 0x40048010, len = 0x10
  sram_mcu0_head_seg :                	org = 0x40048020, len = 0x3FE0
  sram_mcu0_data_text_seg :           	org = 0x4004C000, len = 0x20000
...
PHDRS
{
  ...
  iram0_test_lit_phdr PT_LOAD;
  iram0_test_phdr PT_LOAD;
...
_memmap_seg_iram0_text_start = 0x20000900;
_memmap_seg_iram0_text_max   = 0x20006900;
_memmap_seg_iram0_test_lit_start = 0x20006900;
_memmap_seg_iram0_test_lit_max   = 0x20006910;
_memmap_seg_iram0_test_start = 0x20006910;
_memmap_seg_iram0_test_max   = 0x20007d10;
_memmap_seg_sram_mcu0_entrance_lit_start = 0x40048000;
_memmap_seg_sram_mcu0_entrance_lit_max   = 0x40048010;
_memmap_seg_sram_mcu0_entrance_text_start = 0x40048010;
_memmap_seg_sram_mcu0_entrance_text_max   = 0x40048020;
_memmap_seg_sram_mcu0_head_start = 0x40048020;
_memmap_seg_sram_mcu0_head_max   = 0x4004c000;
_memmap_seg_sram_mcu0_data_text_start = 0x4004c000;
_memmap_seg_sram_mcu0_data_text_max   = 0x4006c000;
...
SECTIONS
{
  ...
  OTFB.literal (NOLOAD) : ALIGN(4)
  {
    OTFB_literal_start = ABSOLUTE(.);
    *(OTFB.literal)
    OTFB_literal_end = ABSOLUTE(.);
    _memmap_seg_iram0_test_lit_end = ALIGN(0x8);
  } >iram0_test_lit_seg :iram0_test_lit_phdr

  OTFB.text (NOLOAD) : ALIGN(4)
  {
    OTFB_text_start = ABSOLUTE(.);
    *(OTFB.text)
    OTFB_text_end = ABSOLUTE(.);
    _memmap_seg_iram0_test_end = ALIGN(0x8);
  } >iram0_test_seg :iram0_test_phdr
  ...
  .mcu0entrance.literal : ALIGN(4)
  {
    _mcu0entrance_literal_start = ABSOLUTE(.);
    KEEP (*(.mcu0entrance.literal))
    _mcu0entrance_literal_end = ABSOLUTE(.);
    _memmap_seg_sram_mcu0_entrance_lit_end = ALIGN(0x8);
  } >sram_mcu0_entrance_lit_seg :sram_mcu0_entrance_lit_phdr

  .mcu0entrance.text : ALIGN(4)
  {
    _mcu0entrance_text_start = ABSOLUTE(.);
    KEEP (*(.mcu0entrance.text))
    _mcu0entrance_text_end = ABSOLUTE(.);
    _memmap_seg_sram_mcu0_entrance_text_end = ALIGN(0x8);
  } >sram_mcu0_entrance_text_seg :sram_mcu0_entrance_text_phdr

  .mcu0head.literal : ALIGN(4)
  {
    _mcu0head_literal_start = ABSOLUTE(.);
    KEEP (*(.mcu0head.literal))
    _mcu0head_literal_end = ABSOLUTE(.);
  } >sram_mcu0_head_seg :sram_mcu0_head_phdr

  .mcu0head.text : ALIGN(4)
  {
    _mcu0head_text_start = ABSOLUTE(.);
    KEEP (*(.mcu0head.text))
    _mcu0head_text_end = ABSOLUTE(.);
    _memmap_seg_sram_mcu0_head_end = ALIGN(0x8);
  } >sram_mcu0_head_seg :sram_mcu0_head_phdr

  .mcu0dram.data : ALIGN(4)
  {
    _mcu0dram_data_start = ABSOLUTE(.);
    KEEP (*(.mcu0dram.data))
    _mcu0dram_data_end = ABSOLUTE(.);
  } >sram_mcu0_data_text_seg :sram_mcu0_data_text_phdr

  .mcu0dram.literal : ALIGN(4)
  {
    _mcu0dram_literal_start = ABSOLUTE(.);
    KEEP (*(.mcu0dram.literal))
    _mcu0dram_literal_end = ABSOLUTE(.);
  } >sram_mcu0_data_text_seg :sram_mcu0_data_text_phdr

  .mcu0dram.text : ALIGN(4)
  {
    _mcu0dram_text_start = ABSOLUTE(.);
    KEEP (*(.mcu0dram.text))
    _mcu0dram_text_end = ABSOLUTE(.);
    _memmap_seg_sram_mcu0_data_text_end = ALIGN(0x8);
  } >sram_mcu0_data_text_seg :sram_mcu0_data_text_phdr
